...
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Account email          | `users.email`, Better Auth component user table, `guests.email`, `importedTicketHolders.email`, `guest_sessions.email`, `tickets.guestEmailLower`, `tickets.rosterEmail`/`tickets.rosterEmailLower`, `emailAddressMarketingPreferences.email`, `resale_notifications.email`, `admin_invites.email`, `emailDeliveries.recipient`, `emailDeliveryFailures.recipient`, `eventBroadcastDeliveries.email` |
