...
6. Check if Do Not Track or GPC is enabled in the test browser (PostHog respects both)
...
| Payment-category `feedback_submitted`           | Review support channels and checkout health dashboards; raw feedback text is not stored in PostHog.                                             |
