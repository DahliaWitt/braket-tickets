...
export const ADMIN_AUDIT_ACTIONS = {
  ...
  IMPORTED_TICKETS_IMPORT: 'imported_tickets.import',
...
export const adminAuditCheckInActionValidator = v.union(
  ...
  v.literal(ADMIN_AUDIT_ACTIONS.IMPORTED_TICKET_CHECK_IN),
);
...
export const ADMIN_AUDIT_ACTIONS_BY_CATEGORY = {
  event: [
    ...
    ADMIN_AUDIT_ACTIONS.GUEST_IMPORT,
    ADMIN_AUDIT_ACTIONS.GUEST_UPDATE,
    ADMIN_AUDIT_ACTIONS.IMPORTED_TICKETS_IMPORT,
    ADMIN_AUDIT_ACTIONS.IMPORTED_TICKETS_REMOVE,
    ADMIN_AUDIT_ACTIONS.IMPORTED_TICKETS_BATCH_REMOVE,
    ADMIN_AUDIT_ACTIONS.IMPORTED_TICKETS_REDACT,
  ],
  application: [
  ...
  'check-in': [
    ...
    ADMIN_AUDIT_ACTIONS.IMPORTED_TICKET_CHECK_IN,
