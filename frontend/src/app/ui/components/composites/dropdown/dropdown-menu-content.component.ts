...
import { dropdownContentVariants } from '@ui/components/composites/dropdown/dropdown.variants';
import { mergeClasses } from '@ui/utils/merge-classes';

@Component({
  selector: 'bra-dropdown-menu-content',
  template: `
  ...
  exportAs: 'braDropdownMenuContent',
})
export class BraDropdownMenuContentComponent {
