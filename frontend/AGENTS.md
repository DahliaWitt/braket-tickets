...
- For any UI, copy, or visual change, follow `docs/design/brand-rules.md` — the authoritative, citable design rules (lowercase copy voice, Syne/Inter/Space Mono typography, semantic-token-only color, 4px mixed radius, sanctioned effects, WCAG 2.2 AA)
