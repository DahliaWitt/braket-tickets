...
## [0.1.17](https://github.com/DahliaWitt/braket-tickets/compare/v0.1.16...v0.1.17) (2026-08-01)
...
* **admin:** rich text broadcast & reminder emails with secure inline images ([#188](https://github.com/DahliaWitt/braket-tickets/issues/188)) ([d894b13](https://github.com/DahliaWitt/braket-tickets/commit/d894b13a36ce0f694b4762954aa44172c7bb0ad8))
...
* **auth:** reject breached passwords on signup and reset via haveIBeenPwned ([#172](https://github.com/DahliaWitt/braket-tickets/issues/172)) ([5eece15](https://github.com/DahliaWitt/braket-tickets/commit/5eece1548eb0f958fb330f25a0f94fd204260a3d))
...
* **events:** unfurl event links with the flier via OG meta injection ([#272](https://github.com/DahliaWitt/braket-tickets/issues/272)) ([91ac505](https://github.com/DahliaWitt/braket-tickets/commit/91ac505c377e17b94ce6b5532215de659f7e2d5a))
...
* **frontend:** wire NgOptimizedImage with Cloudflare image transformations ([db05d8d](https://github.com/DahliaWitt/braket-tickets/commit/db05d8d852472ef0260f7ea33692990d730d0521))
* **frontend:** wire NgOptimizedImage with Cloudflare image transformations ([62299c8](https://github.com/DahliaWitt/braket-tickets/commit/62299c8a3756ca99695f729b5b95949aa2d8fabe))
...
* **tickets:** require ToS assent for guest checkout and free ticket claim ([#161](https://github.com/DahliaWitt/braket-tickets/issues/161)) ([b603eec](https://github.com/DahliaWitt/braket-tickets/commit/b603eecb09630c4b7301485a416274ec035f941b))
...
* **a11y:** AA-safe dark-mode foreground for filled success/warning surfaces (BRA-456) ([#192](https://github.com/DahliaWitt/braket-tickets/issues/192)) ([5d45b03](https://github.com/DahliaWitt/braket-tickets/commit/5d45b034e3802e00dae0c2a00ac9ae7d58e55318))
* **a11y:** AA-safe destructive/info text tokens for dark-mode contrast (BRA-263) ([#160](https://github.com/DahliaWitt/braket-tickets/issues/160)) ([bf4e544](https://github.com/DahliaWitt/braket-tickets/commit/bf4e5445e3a5ecd93ccc02c5af7326904e0f7020))
* **a11y:** correct select aria-activedescendant with disabled options ([#224](https://github.com/DahliaWitt/braket-tickets/issues/224)) ([1b54c9a](https://github.com/DahliaWitt/braket-tickets/commit/1b54c9a1040492247fb705b5695bd2f42c682dcd))
* **access:** restrict draft/cancelled event visibility to organizers ([#209](https://github.com/DahliaWitt/braket-tickets/issues/209)) ([593b824](https://github.com/DahliaWitt/braket-tickets/commit/593b82460df967666d5f7f4d4fd9b70b4c2ccc51))
...
* **admin:** community admin a11y, tokens, and controls ([#234](https://github.com/DahliaWitt/braket-tickets/issues/234)) ([3764be9](https://github.com/DahliaWitt/braket-tickets/commit/3764be93d0359be53bd150521f960f41614ed1c1))
* **admin:** CSV blank lines must not count against import record cap ([#208](https://github.com/DahliaWitt/braket-tickets/issues/208)) ([e966c48](https://github.com/DahliaWitt/braket-tickets/commit/e966c485b908e79eeed349ff03963b22e5f3f11d))
* **admin:** make ApexCharts chart-type registration deterministic ([#254](https://github.com/DahliaWitt/braket-tickets/issues/254)) ([72e954d](https://github.com/DahliaWitt/braket-tickets/commit/72e954d73ee208ee296caaf0da290c1f8361c9db))
...
* **admin:** persist cleared optional fields in event & community editors ([#225](https://github.com/DahliaWitt/braket-tickets/issues/225)) ([868f6e8](https://github.com/DahliaWitt/braket-tickets/commit/868f6e8e6a405d85a17293c1aba0171a529214a3))
...
* **admin:** table overflow, destructive contrast, confirm dialogs, and empty states ([#236](https://github.com/DahliaWitt/braket-tickets/issues/236)) ([22f88a5](https://github.com/DahliaWitt/braket-tickets/commit/22f88a5858ad6d9d66cd5607224bdd5bd8ffc8d3))
...
* **auth:** confirm social link from session instead of nonexistent OTT ([#250](https://github.com/DahliaWitt/braket-tickets/issues/250)) ([b755d54](https://github.com/DahliaWitt/braket-tickets/commit/b755d549cd5bf09c48a3484b694a26d22f88be16))
* **auth:** do not treat transient getSession errors as logged-out ([#201](https://github.com/DahliaWitt/braket-tickets/issues/201)) ([4b921f2](https://github.com/DahliaWitt/braket-tickets/commit/4b921f2f6b12b2bcf813467402fae4b8e45a315a))
* **auth:** enforce terms-acceptance gate server-side for social signups ([#186](https://github.com/DahliaWitt/braket-tickets/issues/186)) ([122098a](https://github.com/DahliaWitt/braket-tickets/commit/122098ab0cf923423277074a931ccdb05fc5ae37))
* **auth:** keyboard access, contrast tokens, and state fixes across auth surfaces ([#231](https://github.com/DahliaWitt/braket-tickets/issues/231)) ([22c1dea](https://github.com/DahliaWitt/braket-tickets/commit/22c1dea03fe901a27fa37f59afc1176a0b733cd5))
* **auth:** reject backslash open-redirect callbackURL bypass ([#205](https://github.com/DahliaWitt/braket-tickets/issues/205)) ([b8f9c13](https://github.com/DahliaWitt/braket-tickets/commit/b8f9c1345e2581fde2d0cc9d238e40e22ef157c7))
* **auth:** route resend-verification failures to the correct error state ([#229](https://github.com/DahliaWitt/braket-tickets/issues/229)) ([3b245d6](https://github.com/DahliaWitt/braket-tickets/commit/3b245d659723ac2d3c8b102b228364aac5e493dc))
* **auth:** terminate missing-user repair loop on persistent query error ([#226](https://github.com/DahliaWitt/braket-tickets/issues/226)) ([7e150bb](https://github.com/DahliaWitt/braket-tickets/commit/7e150bbd2fd6c8240d2989c0b0809f4da575ff9a))
...
* **calendar:** guard generateCalendarDays against Invalid Date infinite loop ([#215](https://github.com/DahliaWitt/braket-tickets/issues/215)) ([87105ab](https://github.com/DahliaWitt/braket-tickets/commit/87105ab0b5680d23275ea9a9b99a94d5242b4834))
* **calendar:** month navigation must not roll over on 29th–31st ([#198](https://github.com/DahliaWitt/braket-tickets/issues/198)) ([d9961c3](https://github.com/DahliaWitt/braket-tickets/commit/d9961c3af319cee8e71dbe74191591a29ade5103))
...
* **ci:** gate deploy workflows on branch CI ([a4b3d1b](https://github.com/DahliaWitt/braket-tickets/commit/a4b3d1b362c6d5097070381d6cbf487f1e4cf102))
...
* **communities:** one at-cap organizer must not fail the trust-links page ([#221](https://github.com/DahliaWitt/braket-tickets/issues/221)) ([cf024f1](https://github.com/DahliaWitt/braket-tickets/commit/cf024f1ad4417617035a3c68049232aa868c701e))
...
* **convex:** bound admin notification scan in application submission ([#252](https://github.com/DahliaWitt/braket-tickets/issues/252)) ([88d26db](https://github.com/DahliaWitt/braket-tickets/commit/88d26db533fd72f132b8d8ac2226b2643647b4f6))
* **convex:** single-pass pagination for roster and directory search ([#190](https://github.com/DahliaWitt/braket-tickets/issues/190)) ([40b174b](https://github.com/DahliaWitt/braket-tickets/commit/40b174bd337e808f9e7312477e5d57b951944f10))
...
* **dialog:** scope Escape-to-close to the topmost overlay ([#202](https://github.com/DahliaWitt/braket-tickets/issues/202)) ([d592ce1](https://github.com/DahliaWitt/braket-tickets/commit/d592ce188488b6e3fd920cb69b8ec7e8f3bbfd9d))
* **directory:** bound directory email search to membership, drop global users scan ([#206](https://github.com/DahliaWitt/braket-tickets/issues/206)) ([ad0dd75](https://github.com/DahliaWitt/braket-tickets/commit/ad0dd752a4b8c09a4f407540a10f67e9e18953e9))
...
* **docs:** correct accuracy issues from PR review ([38514e5](https://github.com/DahliaWitt/braket-tickets/commit/38514e5a9deb3728bff884469a0f9f766a6b4e38))
...
* **email:** stop leaking requireDelivery into provider action args ([#249](https://github.com/DahliaWitt/braket-tickets/issues/249)) ([7a3a5db](https://github.com/DahliaWitt/braket-tickets/commit/7a3a5dbe7e7cb260a0d08c5da9f7fe477d87fee9))
...
* **events:** allow clearing an existing optional end date from the editor ([#253](https://github.com/DahliaWitt/braket-tickets/issues/253)) ([ad6f2b5](https://github.com/DahliaWitt/braket-tickets/commit/ad6f2b5bf4c903b932e2524620b8a35b8968a0c9))
* **events:** apply guests.add email validation to guests.update ([#222](https://github.com/DahliaWitt/braket-tickets/issues/222)) ([28852d0](https://github.com/DahliaWitt/braket-tickets/commit/28852d06fb532d054cec9554a6e3805f198e302c))
...
* **events:** persist disabling sliding-scale pricing ([#199](https://github.com/DahliaWitt/braket-tickets/issues/199)) ([b3f3a0e](https://github.com/DahliaWitt/braket-tickets/commit/b3f3a0e4ea769335dbe2a98f19548e070c54e40c))
* **events:** preserve guest email-send lock across guests.update ([#212](https://github.com/DahliaWitt/braket-tickets/issues/212)) ([0a22bbf](https://github.com/DahliaWitt/braket-tickets/commit/0a22bbf6d66e59fb60c9fcc7f007f174c1f39592))
...
* **guest-sessions:** terminate expired-session cleanup and clear backlog ([#195](https://github.com/DahliaWitt/braket-tickets/issues/195)) ([8518270](https://github.com/DahliaWitt/braket-tickets/commit/8518270b34eca4a0763820ef472936dfe4bfef02))
...
* **help:** sidebar a11y semantics, state coverage, and brand voice ([#232](https://github.com/DahliaWitt/braket-tickets/issues/232)) ([ebf4b83](https://github.com/DahliaWitt/braket-tickets/commit/ebf4b83c4fe47981f2ffaf8d496f46b3b6779f55))
...
* **logging:** redact key=value secrets without surrounding whitespace ([#219](https://github.com/DahliaWitt/braket-tickets/issues/219)) ([29c35a2](https://github.com/DahliaWitt/braket-tickets/commit/29c35a2726b546702cc93c26fff060b76424ec0b))
* **marketing:** freeze digest time window across pagination pages ([#204](https://github.com/DahliaWitt/braket-tickets/issues/204)) ([170c465](https://github.com/DahliaWitt/braket-tickets/commit/170c4654dfbddd5da62ecc281e1c5f8d711d7d2c))
* **marketing:** guest migration must not override user marketing opt-out ([#194](https://github.com/DahliaWitt/braket-tickets/issues/194)) ([ed42746](https://github.com/DahliaWitt/braket-tickets/commit/ed427465c96e4cc7a6acb2a8cd48d003f967b52c))
* **member:** directory badges, dashboard contrast, and empty states ([#233](https://github.com/DahliaWitt/braket-tickets/issues/233)) ([21df0fa](https://github.com/DahliaWitt/braket-tickets/commit/21df0fad2fa4caf34fac782d96411a249aa32f0c))
...
* **orders:** correct free-ticket idempotency so repeat claims issue tickets ([#197](https://github.com/DahliaWitt/braket-tickets/issues/197)) ([0c43bee](https://github.com/DahliaWitt/braket-tickets/commit/0c43beebc64de9ddaa09211a87c2ab0a34e70ac2))
* **orders:** external refunds must not invalidate checked-in tickets ([#193](https://github.com/DahliaWitt/braket-tickets/issues/193)) ([df1eeb0](https://github.com/DahliaWitt/braket-tickets/commit/df1eeb0d9352bcf495b9c03ef62055d8f79b335b))
...
* **pricing:** render cent amounts with trailing zero ([#220](https://github.com/DahliaWitt/braket-tickets/issues/220)) ([6d1d94e](https://github.com/DahliaWitt/braket-tickets/commit/6d1d94eeea0692d386d9cca8c35438a388d79ca4))
* **public:** unsubscribe correctness, landing states, legal links, and voice ([#235](https://github.com/DahliaWitt/braket-tickets/issues/235)) ([1c1e9df](https://github.com/DahliaWitt/braket-tickets/commit/1c1e9df0b77edd2c89cdf74c8e2312900f208269))
* **qa:** resolve pre-production audit findings ([#248](https://github.com/DahliaWitt/braket-tickets/issues/248)) ([1c622b6](https://github.com/DahliaWitt/braket-tickets/commit/1c622b655b2e71523f5cf31b521c709b796691ae))
* **resale:** let a buyer resume their own held resale listing on retry ([#210](https://github.com/DahliaWitt/braket-tickets/issues/210)) ([94a6855](https://github.com/DahliaWitt/braket-tickets/commit/94a6855e0a70a79d91f9b0aec762f0304b1162c5))
...
* **storage:** orphan-upload cleanup must reach orphans past confirmed backlog ([#207](https://github.com/DahliaWitt/braket-tickets/issues/207)) ([9bc1109](https://github.com/DahliaWitt/braket-tickets/commit/9bc1109f5160258f9cf3b8a9d1f49d460d0a26e5))
...
* **storybook:** dedupe react/react-dom to unblock docs rendering ([eae9019](https://github.com/DahliaWitt/braket-tickets/commit/eae9019df79851335f00ec7f56714eb722647886))
...
* **storybook:** enable GFM in addon-docs for MDX pipe-tables ([572f4a3](https://github.com/DahliaWitt/braket-tickets/commit/572f4a36ba42d6932fdde446ab02d3f324ff3a20))
...
* **stripe:** stop reaper from failing webhook claims released for retry ([#196](https://github.com/DahliaWitt/braket-tickets/issues/196)) ([3edeebf](https://github.com/DahliaWitt/braket-tickets/commit/3edeebf3a961eb7785d67443d835174d5e1cc21c))
* **stripe:** vary checkout idempotency key so session restarts don't wedge ([#203](https://github.com/DahliaWitt/braket-tickets/issues/203)) ([5d857fb](https://github.com/DahliaWitt/braket-tickets/commit/5d857fb1142716c1b05de3c9298c6239fa45aafa))
* **tickets:** consult payment-error code map before raw message ([#214](https://github.com/DahliaWitt/braket-tickets/issues/214)) ([a9b58e0](https://github.com/DahliaWitt/braket-tickets/commit/a9b58e0e4e1ede9506795ba47d49b46bb44e3cdf))
* **tickets:** enforce sliding-scale bounds and lock checkout selection during session creation ([#218](https://github.com/DahliaWitt/braket-tickets/issues/218)) ([ecc1d88](https://github.com/DahliaWitt/braket-tickets/commit/ecc1d8855d079287fd1fedf9e131ad8228eddd2b))
...
* **ui:** AA-safe hovers and self-tinted text tokens in the UI kit ([#228](https://github.com/DahliaWitt/braket-tickets/issues/228)) ([60e66e3](https://github.com/DahliaWitt/braket-tickets/commit/60e66e379aaad46305c388d325588cfc667e4b32))
* **ui:** clamp slider value to zMax when range is not a step multiple ([#216](https://github.com/DahliaWitt/braket-tickets/issues/216)) ([f33bc7c](https://github.com/DahliaWitt/braket-tickets/commit/f33bc7c58dfa6bd918a4dea7e36a1acd06002cdf))
* **ui:** keep hover dropdown open while moving pointer to the menu ([#223](https://github.com/DahliaWitt/braket-tickets/issues/223)) ([4736c7d](https://github.com/DahliaWitt/braket-tickets/commit/4736c7dece3d657b0691abe35b22d739f5f777fb))
* **ui:** kit radius, dialog overflow, size scales, and interaction affordances ([#230](https://github.com/DahliaWitt/braket-tickets/issues/230)) ([9266501](https://github.com/DahliaWitt/braket-tickets/commit/92665011186bc157ae263da91ec8a515fa26553d))
* **ui:** remove gradient text and glows from the app shell ([#227](https://github.com/DahliaWitt/braket-tickets/issues/227)) ([d951ad1](https://github.com/DahliaWitt/braket-tickets/commit/d951ad14e4607eeafe92a15d626562ed41815976))
...
* **ui:** wire popover outside-click dismissal after overlay creation ([#217](https://github.com/DahliaWitt/braket-tickets/issues/217)) ([d47af65](https://github.com/DahliaWitt/braket-tickets/commit/d47af65cdbd75bf27ac1d5e8149ae749733e2946))
* **vetting:** do not submit unanswered optional booleans as No ([#213](https://github.com/DahliaWitt/braket-tickets/issues/213)) ([262d306](https://github.com/DahliaWitt/braket-tickets/commit/262d30601ce1f27951f6937963528c7a48c19463))
...
* **admin:** migrate broadcast + ticket-reminder inputs to zInput (BRA-251) ([#191](https://github.com/DahliaWitt/braket-tickets/issues/191)) ([9e6a30e](https://github.com/DahliaWitt/braket-tickets/commit/9e6a30eabc20b679293cec687c4dfbe306f50022))
* **admin:** migrate empty states to app-empty-state (BRA-249) ([#187](https://github.com/DahliaWitt/braket-tickets/issues/187)) ([6db70c6](https://github.com/DahliaWitt/braket-tickets/commit/6db70c6d83c70fc7d4e0b14e3c4a5f3c33bae421))
...
* **auth:** match better-auth machine error codes over message substrings ([#170](https://github.com/DahliaWitt/braket-tickets/issues/170)) ([463f845](https://github.com/DahliaWitt/braket-tickets/commit/463f845cd3bc5cd3e33e083650deb1ed51049289))
* better-auth 0.12.5 type hygiene (adapter casts, auth client, helper header) ([#164](https://github.com/DahliaWitt/braket-tickets/issues/164)) ([b5591f3](https://github.com/DahliaWitt/braket-tickets/commit/b5591f3b92b8cd635a0d6656c479e838d7deb442))
...
* **frontend:** adopt convex-angular injectQueries/injectQuery over DIY query patterns ([#171](https://github.com/DahliaWitt/braket-tickets/issues/171)) ([7833066](https://github.com/DahliaWitt/braket-tickets/commit/783306673434d6dcbaad2f9f535f42368f06ba7a))
...
* replace hand-rolled better-auth internals with library APIs ([#165](https://github.com/DahliaWitt/braket-tickets/issues/165)) ([348ce4b](https://github.com/DahliaWitt/braket-tickets/commit/348ce4b8f46b7002c240b0f0d349dc2ebdafd859))
...
* **ci:** document release merge policy ([672cebd](https://github.com/DahliaWitt/braket-tickets/commit/672cebd95a7102a06628963095d31e21216e1b00))
...
* **ci:** document whiterose runner fleet ([39e3961](https://github.com/DahliaWitt/braket-tickets/commit/39e39616b5bee2fda28eab2c25db9d33d5a4bfc7))
* **convex:** correct false claim that db.patch ignores undefined fields ([#200](https://github.com/DahliaWitt/braket-tickets/issues/200)) ([b96d107](https://github.com/DahliaWitt/braket-tickets/commit/b96d107aaa8f99f76f90657d25880e7e5c0c5509))
...
* **cujs:** rewrite as goal-centric inventory grounded in code ([8680977](https://github.com/DahliaWitt/braket-tickets/commit/8680977558fef61670d6f7eac245fb1f8c2aca77))
* **cujs:** rewrite as goal-centric inventory grounded in code ([8058a2f](https://github.com/DahliaWitt/braket-tickets/commit/8058a2f4603f4a67d01bff433bd17097463f1c03))
* **design:** re-derive .impeccable.md from event flyers, purge canonized slop motifs ([#238](https://github.com/DahliaWitt/braket-tickets/issues/238)) ([a41db4a](https://github.com/DahliaWitt/braket-tickets/commit/a41db4a20c351b32506aae99c529073e0ee84a05))
...
* overhaul help documentation for users and admins ([50534ec](https://github.com/DahliaWitt/braket-tickets/commit/50534ec1bca4d7d5df5b396923685cc2a69f7b09))
* overhaul help documentation for users and admins ([b86d6e3](https://github.com/DahliaWitt/braket-tickets/commit/b86d6e36e0893698b718d134eab7ff51a7fdced6))
...
* **runbooks:** reflect strict:false on develop branch protection ([#185](https://github.com/DahliaWitt/braket-tickets/issues/185)) ([5de7b87](https://github.com/DahliaWitt/braket-tickets/commit/5de7b8715605cedca653fc8022703efef333c7cb))
...
* move E2E to GitHub-hosted runners (phase 1) ([#168](https://github.com/DahliaWitt/braket-tickets/issues/168)) ([c051ebe](https://github.com/DahliaWitt/braket-tickets/commit/c051ebef93c5d5bf0eaa056127647591ba5636a7))
